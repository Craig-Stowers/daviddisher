...
// function PrevLink({ images, slug }) {
//   return ({ params }) => {
//     const currentIndex = parseInt(params.imageId);
//     const prevIndex = currentIndex > 0 ? currentIndex - 1 : images.length - 1; // Wrap around
//     return <Link href={`/album/${slug}/image/${prevIndex}`} scroll={false}>Prev</Link>;
//   };
// }

// function NextLink({ images, slug }) {
//   return ({ params }) => {
//     const currentIndex = parseInt(params.imageId);
//     const nextIndex = currentIndex < images.length - 1 ? currentIndex + 1 : 0; // Wrap around
//     return <Link href={`/album/${slug}/image/${nextIndex}`} scroll={false}>Next</Link>;
//   };
// }
